...
def _interpret_signals(alertas: list) -> str:
    ...
    if buy_count > sell_count:
        return f"El portafolio muestra <strong>sesgo alcista</strong>: {buy_count} activo(s) con señal de compra frente a {sell_count} de venta."
    elif sell_count > buy_count:
        return f"El portafolio muestra <strong>sesgo bajista</strong>: {sell_count} activo(s) con señal de venta frente a {buy_count} de compra."
    else:
        return f"Señales mixtas ({neutral_count} neutral, {buy_count} compra, {sell_count} venta). Esperar confirmación de dirección."
